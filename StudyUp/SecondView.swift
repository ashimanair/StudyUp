...
struct SecondView: View {
  ...
  @State private var desiredDuration = Calendar.current.date(byAdding: .minute, value: 25, to: Date())!
    ...
    NavigationView {
      ZStack {
        ...
        NavigationLink(destination: ToDoList()) {
            ...
            NavigationLink(destination: SecondBreakView()) {
                Text("You can click here to go to your break once the timer is done!")
                  .font(.title3)
                  .foregroundColor(Color(red: 0.874, green: 0.617, blue: 0.622))
                  .multilineTextAlignment(.center)
                  .padding()
